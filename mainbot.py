...
while True:
    user = api.get_user('VarunKu69696015')
    api.update_profile(name=f'Varun Kulkarni|{follower_count(user)} Followers')
    print(f'Updating Twitter Name : Varun Kulkarni|{follower_count(user)} Followers')
